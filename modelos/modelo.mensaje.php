<?php
	require_once 'libreria_correo/PHPMailer/src/Exception.php';
	require_once 'libreria_correo/PHPMailer/src/PHPMailer.php';
	require_once 'libreria_correo/PHPMailer/src/SMTP.php';
